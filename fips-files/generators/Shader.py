...
def writeProgramSource(f, shdLib, prog, slangs) :
    ...
    for slang in slangs:
        ...
        if isGLSL(slang):
            ...
            f.write('    setup.SetProgramFromByteCode({}, (const uint8_t *){}, sizeof({}), (const uint8_t *){}, sizeof({}));\n'.format(
            ...
            f.write('    setup.SetProgramFromByteCode({}, (const uint8_t *){}, sizeof({}), (const uint8_t *){}, sizeof({}), "main0", "main0");\n'.format(
                slangType, vs_c_name, vs_c_name, fs_c_name, fs_c_name))
